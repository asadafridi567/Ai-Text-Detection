...
class AIDetectionView(APIView):
    ...
    FLASK_AI_API_URL = "https://b67158a420c4.ngrok-free.app/check-ai/"
...
class HumanizeTextView(APIView):
    ...
    # Allow both JSON (for direct text input) and MultiPart/Form (for file uploads)
    parser_classes = [JSONParser, MultiPartParser, FormParser]
    FLASK_HUMANIZE_API_URL = "https://b67158a420c4.ngrok-free.app/humanize/" # Example: Adjust if using ngrok
